...
<head>
	...
	<!-- Fav Icon -->
	<link rel="shortcut icon" type="image/x-icon" href="{{ asset('img\logos-new.png') }}" />
		...
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
				<a href="{{ route('front.home') }}" class="text-decoration-none">
					<span class="h1 text-uppercase text-info bg-dark px-2">KPOP</span>
					<span class="h1 text-uppercase text-dark bg-info px-2 ml-n1">STORE</span>
				</a>
			</div>
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="{{ route("front.home") }}" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-primary bg-dark">KPOP</span>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3>About Us</h3>
					<p>We are your ultimate K-Pop shop, providing the latest merchandise, albums, and more. <br>
					Semarang Street, Central Java, Indonesia <br>
					samuelkris99@gmail.com <br>
					0859 0020 8018</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>© Copyright 2024 Gfriend Shop By Samuel. All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
