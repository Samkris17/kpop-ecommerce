...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Agu 2024 pada 08.55
...
(1, 'GFRIEND', 'gfriend', 1, '2024-08-03 09:10:46', '2024-08-03 09:10:46');
...
(1, 'Lightstick', 'lightstick', '1.jpg', 1, 'Yes', '2024-08-03 09:06:20', '2024-08-03 09:06:20');
...
(5, '2023_08_21_050555_alter_users_table', 1),
(6, '2023_08_22_012520_create_categories_table', 1),
(7, '2023_08_22_041358_create_temp_images_table', 1),
(8, '2023_08_23_045433_create_sub_categories_table', 1),
(9, '2023_08_23_075108_create_brands_table', 1),
(10, '2023_08_24_020619_create_products_table', 1),
(11, '2023_08_24_020637_create_product_images_table', 1),
(12, '2023_08_28_012420_alter_categories_table', 1),
(13, '2023_08_28_012827_alter_products_table', 1),
(14, '2023_08_28_013126_alter_sub_categories_table', 1),
(15, '2023_08_29_023909_alter_products_table', 1),
(16, '2023_08_31_030449_alter_users_table', 1),
(17, '2023_08_31_062515_create_countries_table', 1),
(18, '2023_09_01_014710_create_orders_table', 1),
(19, '2023_09_01_014731_create_order_items_table', 1),
(20, '2023_09_01_014750_create_customer_addresses_table', 1),
(21, '2023_09_02_010132_create_shipping_charges_table', 1),
(22, '2023_09_04_031854_create_discount_coupons_table', 1),
(23, '2023_09_04_092157_alter_orders_table', 1),
(24, '2023_09_05_022134_alter_orders_table', 1),
(25, '2023_09_06_011042_alter_orders_table', 1),
(26, '2023_09_08_013553_create_wishlists_table', 1),
(27, '2023_09_13_061957_alter_orders_table', 1),
(28, '2023_09_18_005624_alter_users_table', 1),
(29, '2023_09_22_011620_create_pages_table', 1),
(30, '2023_09_25_080504_alter_orders_table', 1),
(31, '2023_11_22_053523_create_product_ratings_table', 1);
...
CREATE TABLE `orders` (
  ...
  `payment_status` enum('1','2','3','4') NOT NULL COMMENT '1=Waiting Payment, 2=Payment Successfull, 3=Expired, 4=Canceled',
...
(1, 'Contact Us', 'contact-us', '<h2 class=\"\"><span style=\"font-family: Helvetica;\"><br></span></h2><h2 class=\"\"><span style=\"font-family: Helvetica;\"><br></span></h2><h2 class=\"\"><b>We are your ultimate K-Pop shop, providing the latest merchandise, albums, and more.</b><br></h2><h3 class=\"\">Semarang Street, Central Java, Indonesia<br>samuelkris99@gmail.com<br>0859 0020 8018</h3>', '2024-08-02 05:05:07', '2024-08-03 22:27:37');
...
(1, 'Official GFRIEND Lightstick Time For The Moon Night', 'official-gfriend-lightstick-time-for-the-moon-night', '<ol><li><b>Desain Unik</b>: Lightstick ini memiliki desain yang elegan dengan dominasi warna putih dan biru, menggambarkan konsep lunar yang menjadi tema utama dari judulnya. Pada bagian atas, terdapat logo GFRIEND yang terukir dengan detail yang presisi.</li><li><b>Lampu LED</b>: Dilengkapi dengan lampu LED yang dapat menghasilkan berbagai warna. Fungsi ini memungkinkan lightstick untuk berkoordinasi dengan penampilan panggung, menciptakan efek visual yang menakjubkan selama konser.</li><li><b>Mode Cahaya</b>: Memiliki beberapa mode cahaya yang dapat disesuaikan, termasuk mode berkedip, mode tetap, dan mode berubah warna otomatis. Setiap mode dapat diatur melalui tombol yang terletak di gagang lightstick.</li><li><b>Baterai</b>: Menggunakan baterai yang dapat diisi ulang atau diganti, sehingga lightstick ini dapat digunakan dalam jangka waktu yang lama tanpa perlu khawatir kehabisan daya di tengah acara.<br></li></ol>', '<p>lightstick resmi dari grup K-pop GFRIEND yang dirilis untuk merayakan era album mereka \"Time For The Moon Night\"<br></p>', '<p><b>Waktu Pengiriman:</b></p><ul><li>Proses pengemasan dan pengiriman memerlukan waktu 2-3 hari kerja setelah pembayaran dikonfirmasi.</li><li>Estimasi waktu pengiriman adalah 7-14 hari kerja, tergantung pada lokasi tujuan.</li></ul><p><br></p><p><b>Kebijakan Pengembalian:</b></p><ul><li>Kami menerima pengembalian produk dalam waktu 14 hari setelah Anda menerima pesanan Anda, dengan syarat produk dalam kondisi asli dan belum digunakan.</li><li>Produk harus dikembalikan dengan kemasan asli dan semua aksesori yang disertakan.</li></ul>', '', 1000.00, 5000.00, 1, 1, 1, 'Yes', 'SKU100-TFTMN', '30042018', 'Yes', 100, 1, '2024-08-03 09:25:59', '2024-08-03 09:27:20');
...
(2, 1, '1-2-1722749092.jpg', NULL, '2024-08-03 22:24:52', '2024-08-03 22:24:52');
...
(1, 'Time For The Moon Night', 'time-for-the-moon-night', 1, 'Yes', 1, '2024-08-03 09:09:17', '2024-08-03 09:09:17');
...
(1, '1722701172.jpg', '2024-08-03 09:06:12', '2024-08-03 09:06:12'),
(2, '1722701954.jpg', '2024-08-03 09:19:14', '2024-08-03 09:19:14');
...
(1, 'Samuel Wahyu Kristianto', 'samuelkris99@gmail.com', '085900208018', 2, 1, NULL, '$2y$10$39w/qNQNKxQdHpmtyl/FmepW7Ufkpk4Gx8vVbyNs6.OzI4k7xjQlK', NULL, '2024-08-02 05:05:06', '2024-08-03 22:45:16');
